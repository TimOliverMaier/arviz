(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("43bcbdb6-b2b5-4bf0-904f-0edf89658baf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '43bcbdb6-b2b5-4bf0-904f-0edf89658baf' but no matching script tag was found.")
        }
